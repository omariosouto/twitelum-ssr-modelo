...
function getActiveRouteFromRoutes(url, router) {
  ...
  var routesArraySample = routesArray.map(function (route) {
    return { path: route.props.path, exact: route.props.exact, component: 'oi' };
  });
  ...
  routesArraySample.forEach(function (route, index) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["matchPath"])(url, route)) {
...
//# sourceMappingURL=0.f8ad1cb7839cf3c77cdb.hot-update.js.map