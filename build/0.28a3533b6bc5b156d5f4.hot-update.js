...
function getActiveRouteFromRoutes(url, router) {
  var routesArray = Object(__WEBPACK_IMPORTED_MODULE_4__routes__["a" /* default */])().props.children.map(function (route) {
    return route;
  });

  var activeRoute = routesArray.find(function (route, index) {
    var routeInfoOnly = { path: route.props.path, exact: route.props.exact };
    var checkPathWithCurrentRoute = Object(__WEBPACK_IMPORTED_MODULE_5_react_router_dom__["matchPath"])(url, routeInfoOnly);
    if (checkPathWithCurrentRoute) {
      console.log(checkPathWithCurrentRoute);
      return __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_assign___default()({}, route, { params: checkPathWithCurrentRoute });
    }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log('extractInitialData', request.params);
...
//# sourceMappingURL=0.28a3533b6bc5b156d5f4.hot-update.js.map