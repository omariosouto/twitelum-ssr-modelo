...
function getActiveRouteFromRoutes(url, router) {
  ...
  var activeRoute = routesArray.find(function (route) {
    var currentPath = route.props.path;
    var urlArray = url.split('/');
    // console.log(currentPath.split('/'))
    // console.log(urlArray)

    var currentRouteUrl = currentPath.split('/').reduce(function (previousValue, currentValue, currentIndex) {
      if (currentIndex > 0) {
        if (previousValue === urlArray[currentIndex - 1]) {
          return previousValue + '/' + urlArray[currentIndex];
        } else {
...
//# sourceMappingURL=0.e4982381645324fbbce5.hot-update.js.map