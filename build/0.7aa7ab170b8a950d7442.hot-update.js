...
var Home = function (_Component) {
    ...
    //   static async getInitialData(requestInfo) {
    //     console.log(requestInfo.cookies)
    //     return {
    //         tweets: {
    //             novoTweet: '',
    //             lista: await fetch(`https://twitelum-api.herokuapp.com/tweets?X-AUTH-TOKEN=${requestInfo.cookies['X-AUTH-TOKEN']}`).then((response) => response.json()).catch((err) => console.log(err)),
    //             tweetAtivo: {}
    //         }
    //       }
    //   }
...
//# sourceMappingURL=0.7aa7ab170b8a950d7442.hot-update.js.map