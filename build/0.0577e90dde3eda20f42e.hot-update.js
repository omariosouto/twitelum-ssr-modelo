...
function getActiveRouteFromRoutes(url, router) {
  ...
  var routesArraySample = routesArray.map(function (route) {
    return { path: route.props.path, exact: route.props.exact };
  });
  console.log(routesArraySample.forEach);
  var activeRoute = void 0;
  routesArraySample.forEach(function (route, index) {
    console.log(Object(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["matchPath"])(url, route[index]), url, route[index]);
    if (Object(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["matchPath"])(url, route[index])) {
      activeRoute = Object(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["matchPath"])(url, route[index]);
    }
  });
...
//# sourceMappingURL=0.0577e90dde3eda20f42e.hot-update.js.map