...
server.disable('x-powered-by').use(__WEBPACK_IMPORTED_MODULE_1_express___default.a.static("/Users/soutomario/Desktop/twitelum-ssr-modelo/public")).get('/*', function (request, resposta) {
  ...
  var activeRoute = Object(__WEBPACK_IMPORTED_MODULE_4__ssr_helpers_js__["c" /* getActiveRouteFromRoutes */])(request.url, __WEBPACK_IMPORTED_MODULE_9__routes__["a" /* default */]);
  ...
  Object(__WEBPACK_IMPORTED_MODULE_4__ssr_helpers_js__["d" /* getCurrentComponent */])(activeRoute.props).then(function (component) {
    return Object(__WEBPACK_IMPORTED_MODULE_4__ssr_helpers_js__["b" /* extractInitialData */])(component, request);
  }).then(function (_ref) {
    ...
    var storeInicial = Object(__WEBPACK_IMPORTED_MODULE_11__store__["a" /* default */])();
    console.log(storeInicial.getState());
    var store = Object(__WEBPACK_IMPORTED_MODULE_11__store__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, storeInicial.getState(), initialData));
...
//# sourceMappingURL=0.b48fc3bcd8668758e23a.hot-update.js.map