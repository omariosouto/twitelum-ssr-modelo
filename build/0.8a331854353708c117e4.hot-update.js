...
var PerfilPage = function (_Component) {
    ...
    function PerfilPage(props) {
        ...
        return __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn___default()(this, (PerfilPage.__proto__ || __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default()(PerfilPage)).call(this));

        // this.state = {
        //     login: props.match.params.login || '',
        //     usuario: window.__PRELOADED_STATE__.usuario
        // }
        // console.log(props)
    }
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch('https://twitelum-api.herokuapp.com/usuarios/omariosouto').then(function (res) {
                                    return res.json();
                                });
...
//# sourceMappingURL=0.8a331854353708c117e4.hot-update.js.map