...
function getActiveRouteFromRoutes(url, router) {
  ...
  activeRoute = routesArray.find(function (route, index) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["matchPath"])(url, routeInfoOnly)) {
      console.log('Oi ' + index, Object(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["matchPath"])(url, routeInfoOnly));
      return { route: route
        // activeRoute = route
      };
    }
...
//# sourceMappingURL=0.95a4c94f60b56be536e4.hot-update.js.map